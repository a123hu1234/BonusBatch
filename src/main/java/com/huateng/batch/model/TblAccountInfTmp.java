...
/**
 * This is an object that contains data related to the TBL_ACCOUNT_INF_TMP table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="TBL_ACCOUNT_INF_TMP"
 */

public  class TblAccountInfTmp extends  TblAccountInf implements Serializable {

	public static String REF = "TblAccountInfTmp";
	...
	public static String getTableClum() {
		String sReturn = "TBL_Account_INF_tmp(CUST_ID,ACCT_ID,CHANGE_DATE,ACCT_NAME,CURRENCY,TXN_AMT,KMH,PRODUCT_NO,PERIOD,OPEN_BANK,OPEN_DATE,ACCT_STATE,OUTSIDE_ACCT,CARD_NO,EXT_COULMN1,EXT_COULMN2,EXT_COULMN3,EXT_COULMN4,EXT_COULMN5,CHANL_NO)";
		return sReturn;
	}
