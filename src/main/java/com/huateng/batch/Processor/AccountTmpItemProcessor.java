 ...
 *
 */
public class AccountTmpItemProcessor extends ValidatingItemProcessor<TblAccountInfTmp>{

    @Override
    public TblAccountInfTmp process(TblAccountInfTmp item) throws ValidationException {
